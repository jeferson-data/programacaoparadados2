...
*(Puxa os dados, cria as tabelas CSV, exibe os resumos e gera os gráficos silenciosamente)*
```bash
!python main.py
```

**3. Visualizar os Gráficos na Tela:**
*(Executa o novo script isolado que vai processar os dados e abrir cada gráfico numa janela interativa do Matplotlib)*
```bash
...
**5. Validar os resultados (sanity check):**
```bash
